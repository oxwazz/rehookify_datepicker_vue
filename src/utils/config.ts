...
const DEFAULT_CALENDAR_CONFIG: DPCalendarConfig = {
  mode: 'static',
  offsets: [0],
  startDay: 0,
}

const DEFAULT_YEARS_CONFIG: DPYearsConfig = {
  mode: 'decade',
  /*
...
const DEFAULT_DATES_CONFIG: Pick<
  DPDatesConfig,
...
const DEFAULT_TIME_CONFIG: Pick<DPTimeConfig, 'interval' | 'useLocales'> = {
  interval: 30,
  useLocales: false,
}
