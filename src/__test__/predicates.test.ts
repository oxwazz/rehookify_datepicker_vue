...
describe('isSame', () => {
  it('isSame should return true if dates is equal', () => {
...
describe('isBefore', () => {
  it('isBefore should return true if date1 < date2', () => {
    const d1 = newDate(2022, 10, 21)
    const d2 = d1
    const d3 = newDate(2022, 10, 21, 12)
...
describe('isAfter', () => {
  it('isAfter should return true if date1 > date2', () => {
    const d1 = newDate(2022, 10, 21)
    const d2 = d1
    const d3 = newDate(2022, 10, 21, 12)
...
describe('isBetween', () => {
  it('isBefore should return true is date1 < date2 < date3 or date1 > date2 > date3', () => {
    const d1 = newDate(2022, 10, 21)
    const d2 = d1
...
describe('maxDateAndAfter', () => {
  it('maxDateAndAfter should return true if maxDate is exist and date > maxDate', () => {
    const d1 = newDate(2022, 10, 21)
...
describe('minDateAndBefore', () => {
  it('minDateAndBefore should return true if minDate is exist and date < minDate', () => {
    const d1 = newDate(2022, 10, 21)
    const d2 = newDate(2022, 10, 30)
...
describe('includeDate', () => {
  it('should return true if dates present in array dates', () => {
    const selected = [
      newDate(2023, 1, 3),
      newDate(2023, 1, 4),
      newDate(2023, 1, 5),
  ...
  it('should return false if dates is not present in array dates', () => {
    const selected = [
      newDate(2023, 1, 3),
      newDate(2023, 1, 4),
      newDate(2023, 1, 5),
...
describe('isBeforeMinMonth', () => {
  it('should return false if minMonth is not exist', () => {
    expect(isBeforeMinMonth(1)).toBe(false)
  })

  it('should return true if month < minMonth', () => {
...
describe('isBeforeMinYear', () => {
  it('should return false if minYear is not exist', () => {
...
describe('isAfterMaxMonth', () => {
  it('should return false if maxMonth is not exist', () => {
    expect(isAfterMaxMonth(1)).toBe(false)
  })

  it('should return true if month > maxMonth', () => {
...
describe('isAfterMaxYear', () => {
  it('should return false if maxYear is not exist', () => {
...
describe('isSameOrAfterMaxYear', () => {
  it('should return false if maxDate is not exist', () => {
    expect(isSameOrAfterMaxYear(2022)).toBe(false)
  })

  it('should return true if year >= maxDate year', () => {
