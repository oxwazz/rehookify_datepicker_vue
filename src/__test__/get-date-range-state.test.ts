...
describe('getDateRangeState', () => {
  ...
  it('should return will-be-in-range', () => {
  ...
  it('should return will-be-range-start', () => {
  ...
  it('should return will-be-range-end', () => {
    const rangeEnd = newDate(2022, 20, 22)
  ...
  // rangeEnd < selectedDates[0]
  it('should return will-be-in-range-start', () => {
  ...
  it('should return will-be-in-range-end', () => {
    const rangeEnd = newDate(2022, 20, 18)
    expect(getDateRangeState(rangeEnd, rangeEnd, selectedDates2, 'range')).toBe(
      'will-be-range-start',
    )
