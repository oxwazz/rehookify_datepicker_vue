...
const DEFAULT_LOCALE_CONFIG: DPLocaleConfig = {
  locale: 'en-GB',
  day: '2-digit',
  year: 'numeric',
  weekday: 'short',
...
describe('getCleanDate', () => {
  it('getCleanDate should return Date without hours, minutes, seconds and milliseconds', () => {
...
describe('daysInMonth', () => {
  it('daysInMonth should return correct number of days', () => {
...
describe('addToDate', () => {
  ...
  it('addToDate adds years correctly', () => {
  ...
  it('addToDate adds months correctly', () => {
  ...
  it('addToDate adds dates correctly', () => {
...
describe('subtractFromDate', () => {
  ...
  it('subtractFromDate subtracts years correctly', () => {
  ...
  it('subtractFromDate subtracts months correctly', () => {
  ...
  it('subtractFromDate subtracts dates correctly', () => {
...
describe('sortDatesAsc', () => {
  it('sortDatesAsc sorts dates in ASC order', () => {
    const testDates = [
      newDate(2022, 10, 20),
      newDate(2021, 11, 31),
      newDate(2022, 8, 11),
...
describe('formatMonthName', () => {
  it('formatMonthName formats moth name according to locale configuration', () => {
...
describe('formatDate', () => {
  it('formatDate formats date according to locale configuration', () => {
...
describe('getDateParts', () => {
  it('getDateParts should return correct date parts', () => {
...
describe('toLocaleDateString', () => {
  it('toLocaleDateString should format date correctly', () => {
    const d1 = newDate(2022, 10, 25)
...
describe('getTimeDate', () => {
  ...
  it('should return date with limit', () => {
...
describe('formatLocaleTime', () => {
  ...
  it('should return time in 24h mode', () => {
    expect(formatLocaleTime(d, DEFAULT_LOCALE_CONFIG)).toBe('22:22')
  })

  it('should return time in 12h mode', () => {
...
describe('addAndSortAsc', () => {
  it('should add and sort dates correctly', () => {
...
describe('formatTime', () => {
  it('should add leading zero before hours and minutes', () => {
